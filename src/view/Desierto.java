...
public class Desierto {
    ...
    public Desierto(Stage stage, EcosistemasController controlador) {
        this.stage = stage;
    ...
    public void start() {
        ...
        Label nombre = new Label("Desierto");
        ...
        String descripcionTexto = model.obtenerDescripcionEcosistema("Desierto");
        descripcion.setText(descripcionTexto);

        // Imagen Principal del Ecosistema
        ImageView img_1 = crearImageView("file:imagenes/Desierto.png", 400, 400);
        grid.add(img_1, 0, 2);

        // Gráfico del Ecosistema
        view.CreaGraficaEcosistema grafica = new view.CreaGraficaEcosistema();
        LineChart<String, Number> grafico = grafica.crearGrafico(6);
        grid.add(grafico, 1, 3, 3, 1);

        // Crear la escena y mostrarla
        Scene scene = new Scene(grid, 1080, 600);
        stage.setScene(scene);
        stage.setTitle("Ventana Ecosistema - Desierto");
        stage.show();
    }
