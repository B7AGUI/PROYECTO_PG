...
public class Especie_2 {
    private Stage stage;
    private VentanaEspeciesController controlador;

    public Especie_2(Stage stage, VentanaEspeciesController controlador) {
        this.stage = stage;
    ...
    public void start() {
        ...
        // **Encabezado**
        Label titulo = crearLabel("Tigre de Bengala (Panthera tigris ssp. tigris)", 24, "-fx-font-weight: bold; -fx-text-fill: white; -fx-background-color: #2a4d69; -fx-padding: 10;");
        ...
        // **Imagen Principal**
        ImageView imagenEspecie = crearImageView("file:imagenes/animal2.png", 400, 0); // Tamaño ajustado grande
        ...
        String model_descripcion = model.obtenerDescripcionEspecie(2);
        ...
        ImageView categoriaRiesgo = crearImageView("file:imagenes/categoria_riesgo_tigre.png", 300, 300);

        // Crear el gráfico dinámico (sin label de gráfico)
        CreaGrafico creaGrafico = new CreaGrafico();
        LineChart<Number, Number> grafico = creaGrafico.crearGrafico(2); // ID de especie: 1 para Oso
        ...
        stage.setTitle("Especie - Tigre de Bengala");
