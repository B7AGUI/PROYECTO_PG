...
public class Especie_1 {
    private Stage stage;
    private VentanaEspeciesController controlador;

    public Especie_1(Stage stage, VentanaEspeciesController controlador) {
        this.stage = stage;
    ...
    public void start() {
        ...
        // **Encabezado**
        Label titulo = crearLabel("Oso Grizzly (Ursus arctos ssp. horribilis)", 24, "-fx-font-weight: bold; -fx-text-fill: white; -fx-background-color: #2a4d69; -fx-padding: 10;");
        ...
        // **Imagen Principal**
        ImageView imagenEspecie = crearImageView("file:imagenes/oso.jpg", 400, 0); // Tamaño ajustado grande
        ...
        String model_descripcion = model.obtenerDescripcionEspecie(1);
        ...
        ImageView categoriaRiesgo = crearImageView("file:imagenes/categoria_riesgo_oso.png", 300, 300);

        // Crear el gráfico dinámico (sin label de gráfico)
        CreaGrafico creaGrafico = new CreaGrafico();
        LineChart<Number, Number> grafico = creaGrafico.crearGrafico(1); // ID de especie: 1 para Oso
        ...
        stage.setTitle("Especie - Oso Grizzly");
