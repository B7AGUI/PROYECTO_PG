...
public class Matorrales {
    ...
    public void start() {
        ...
        Label nombre = new Label("Matorrales");
        ...
        String descripcionTexto = model.obtenerDescripcionEcosistema("Matorrales");
        descripcion.setText(descripcionTexto);

        // Imagen Principal del Ecosistema
        ImageView img_1 = crearImageView("file:imagenes/matorral.png", 400, 400);
        grid.add(img_1, 0, 2);

        // Gráfico del Ecosistema
        view.CreaGraficaEcosistema grafica = new view.CreaGraficaEcosistema();
        LineChart<String, Number> grafico = grafica.crearGrafico(5);
        grid.add(grafico, 1, 3, 3, 1);

        // Crear la escena y mostrarla
        Scene scene = new Scene(grid, 1080, 600);
        stage.setScene(scene);
        stage.setTitle("Ventana Ecosistema - Matorrales");
        stage.show();
    }
